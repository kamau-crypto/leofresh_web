...
export interface ListBinEntity extends BinEntity {
	id: string;
}

export interface DetailedListBinEntity extends ListBinEntity {
	image?: string;
	item_group: string;
}

export interface BinListFilterEntity
	extends Omit<CommonEntity, "fields" | "filters"> {
	warehouse: string;
}
